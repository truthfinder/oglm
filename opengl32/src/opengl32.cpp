...
struct BlendTools {
	static c8 __vectorcall ima(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c.mul<3>(t); } // (Rf*1,Gf*1,Bf*1,AfAt)
	static c8 __vectorcall imi(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c * t; }       // (RfIt,GfIt,BfIt,AfIt)
	static c8 __vectorcall iml(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c * t; }       // (RfLt,GfLt,BfLt,Af*1)
	static c8 __vectorcall im2(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c * t; }       // (RfLt,GfLt,BfLt,AfAt)
	static c8 __vectorcall im3(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c * t; }       // (RfRt,GfGt,BfBt,Af*1)
	static c8 __vectorcall im4(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c * t; }       // (RfRt,GfGt,BfBt,AfAt)
	static c8 __vectorcall ira(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c.mov<3>(t); } // (Rf,Gf,Bf,At)
	static c8 __vectorcall iri(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return t; }           // (It,It,It,It)
	static c8 __vectorcall irl(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return t.mov<3>(c); } // (Lt,Lt,Lt,Af)
	static c8 __vectorcall ir2(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return t; }           // (Lt,Lt,Lt,At)
	static c8 __vectorcall ir3(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return t.mov<3>(c); } // (Rt,Gt,Bt,Af)
	static c8 __vectorcall ir4(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return t; }           // (Rt,Gt,Bt,At)
	static c8 __vectorcall iba(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c * t; }       // (Rf,Gf,Bf,AfAt)
	static c8 __vectorcall ibi(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return (c * (c8::one() - t) + e * t); } // (Rf(1-It)+RcIt,Gf(1-It)+GcIt,Bf(1-It)+BcIt,Af(1-It)+AcIt)
	static c8 __vectorcall ibl(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return (c * (c8::one() - t) + e * t).mov<3>(c); } // (Rf(1-Lt)+RcLt,Gf(1-Lt)+GcLt,Bf(1-Lt)+BcLt,Af)
	static c8 __vectorcall ib2(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return (c * (c8::one() - t) + e * t).mov<3>(c * t); } // (Rf(1-Lt)+RcLt,Gf(1-Lt)+GcLt,Bf(1-Lt)+BcLt,AfAt)
	static c8 __vectorcall ib3(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return (c * (c8::one() - t) + e * t).mov<3>(c); } // (Rf(1-Rt)+RcRt,Gf(1-Gt)+GcGt,Bf(1-Bt)+BcBt,Af)
	static c8 __vectorcall ib4(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return (c * (c8::one() - t) + e * t).mov<3>(c * t); } // (Rf(1-Rt)+RcRt,Gf(1-Gt)+GcGt,Bf(1-Bt)+BcBt,AfAt)
	static c8 __vectorcall id3(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return t.mov<3>(c); } // (Rt,Gt,Bt,Af)
	static c8 __vectorcall id4(cref<c8> c, cref<c8> t, cref<c8> e) noexcept { return c.mad(c8::one() - t.shuf<3>(), t * t.shuf<3>()).mov<3>(c); } // (Rf(1-At)+RtAt,Gf(1-At)+GtAt,Bf(1-At)+BtAt,Af)

	typedef c8(__vectorcall * EnvFmtProc8) (cref<c8> c, cref<c8> t, cref<c8> e);
	static EnvFmtProc8 envFmtTable8[4][6];

	static c8 __vectorcall blendZero8us(cref<c8> s, cref<c8> d) noexcept { return _mm_setzero_si128(); } // (0, 0, 0, 0)
	static c8 __vectorcall blendOne8us (cref<c8> s, cref<c8> d) noexcept { return c8::one(); } //(1, 1, 1, 1)
	static c8 __vectorcall blendSrcColor8us(cref<c8> s, cref<c8> d) noexcept { return s; } // (Rs, Gs, Bs, As)
	static c8 __vectorcall blendDstColor8us(cref<c8> s, cref<c8> d) noexcept { return d; } // (Rd, Gd, Bd, Ad)
	static c8 __vectorcall blendSrcAlpha8us(cref<c8> s, cref<c8> d) noexcept { return s.shuf<3>(); } // (As, As, As, As), _mm_set1_epi16(s.a0)
	static c8 __vectorcall blendDstAlpha8us(cref<c8> s, cref<c8> d) noexcept { return d.shuf<3>(); } // (Ad, Ad, Ad, Ad), _mm_set1_epi16(d.a0)
	static c8 __vectorcall blendOneMinusSrcColor8us(cref<c8> s, cref<c8> d) noexcept { return _mm_sub_epi16(c8::one(), s); } // (1, 1, 1, 1) - (Rs, Gs, Bs, As)
	static c8 __vectorcall blendOneMinusDstColor8us(cref<c8> s, cref<c8> d) noexcept { return _mm_sub_epi16(c8::one(), d); } // (1, 1, 1, 1) - (Rd, Gd, Bd, Ad)
	static c8 __vectorcall blendOneMinusSrcAlpha8us(cref<c8> s, cref<c8> d) noexcept { return _mm_sub_epi16(c8::one(), s.shuf<3>()); } // (1, 1, 1, 1) - (As, As, As, As)
	static c8 __vectorcall blendOneMinusDstAlpha8us(cref<c8> s, cref<c8> d) noexcept { return _mm_sub_epi16(c8::one(), d.shuf<3>()); } // (1, 1, 1, 1) - (Ad, Ad, Ad, Ad)
	static c8 __vectorcall blendSrcAlphaSaturate8us(cref<c8> s, cref<c8> d) noexcept { return s.shuf<3>().min(c8::one() - d.shuf<3>())._and(c8::cmask()) + c8::amask(); } // (f, f, f, 1); f = min(As, 1 - Ad)
